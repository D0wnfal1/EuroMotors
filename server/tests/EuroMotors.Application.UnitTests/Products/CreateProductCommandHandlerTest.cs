...
public class CreateProductCommandHandlerTests
{
    ...
    public async Task Handle_ShouldCreateProductSuccessfully()
    {
        ...
        _categoryRepository.GetByIdAsync(command.CategoryId, CancellationToken.None).Returns(Category.Create("Test Name"));
        _carModelRepository.GetByIdAsync(command.CarModelId, CancellationToken.None).Returns(CarModel.Create("Test Brand", "Test CarModel", 2020, null, BodyType.Sedan, new EngineSpec(6, FuelType.Diesel, 300)));
